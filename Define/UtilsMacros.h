...
//
#define kIphone_x [[UIScreen mainScreen] bounds].size.height >= 812.0
#define kshow_H (KScreenHeight >= 812 ?(KScreenHeight - kScreen_statusBarH - 36):(KScreenHeight))
#define kBottomSafeHeight (kIphone_x?(34.0):(0))
#define kstatusBarH [UIApplication sharedApplication].statusBarFrame.size.height
#define kTabBarHeight 49.0
#define kCustomizeNaiHeight kstatusBarH + 50
#define kCustomizeBottomHeught kTabBarHeight+kBottomSafeHeight
