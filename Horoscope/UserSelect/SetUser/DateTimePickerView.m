...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [cancelButton setTitle:@"Del" forState:UIControlStateNormal];
    ...
    if (self.pickerViewMode == DatePickerViewDateTimeMode) {
        switch (component) {
            ...
            case 3:
            {
                ...
                label.text=[NSString stringWithFormat:@"%ldhour",(long)row];
            }
                break;
            case 4:
            {
                label.textAlignment=NSTextAlignmentRight;
                label.text=[NSString stringWithFormat:@"%ldmim",(long)row];
            }
                break;
            case 5:
            {
                label.textAlignment=NSTextAlignmentRight;
                label.text=[NSString stringWithFormat:@"%ldsecond",(long)row];
            }
                break;
        ...
        switch (component) {
            ...
            {
                label.textAlignment=NSTextAlignmentRight;
                label.text=[NSString stringWithFormat:@"%ldmin",(long)row];
            }
                break;
