...
//  Horoscope
//
//  Created by 刘杰 on 2019/2/20.
//  Copyright © 2019 makerLJ. All rights reserved.
//

#import "AnimationLabel.h"

static const CGFloat kLayerDorpHeight = 300.f;

@interface AnimationLabel () <NSLayoutManagerDelegate>
...
- (void)textLayerAnimation {
    ...
    for (CALayer *aLayer in self.currentTextLayerArray) {
        ...
        NSInteger delay = arc4random()%1000 + 100;
        ...
        dispatch_after(when, dispatch_get_main_queue(), ^{
            ...
            NSInteger ttvlue = arc4random()%80;
            positionAnimation.toValue = [NSNumber numberWithFloat:aLayer.position.y + kLayerDorpHeight - ttvlue];
